  ...
  const loadItems = useCallback(async () => {
    ...
    try {
      ...
      const mock: VaultItem[] = [
        { id:1n,  name:"Void Katana",         season:1, power:95, tier:1, category:"weapon",   maxSupply:3n,   minted:0n, price:BigInt("30000000000000000"),  vaultLocked:false, active:true },
        { id:2n,  name:"Ghost Armor Mk.I",    season:1, power:92, tier:1, category:"armor",    maxSupply:6n,   minted:0n, price:BigInt("25000000000000000"),  vaultLocked:false, active:true },
        { id:3n,  name:"Neural Crown",        season:1, power:88, tier:1, category:"relic",    maxSupply:9n,   minted:0n, price:BigInt("20000000000000000"),  vaultLocked:false, active:true },
        { id:4n,  name:"Samaur-AI Scroll",    season:1, power:85, tier:1, category:"relic",    maxSupply:11n,  minted:0n, price:BigInt("18000000000000000"),  vaultLocked:false, active:true },
        { id:5n,  name:"Phantom Blade",       season:1, power:82, tier:1, category:"weapon",   maxSupply:12n,  minted:0n, price:BigInt("16000000000000000"),  vaultLocked:false, active:true },
        { id:6n,  name:"Hex Shield",          season:1, power:80, tier:1, category:"armor",    maxSupply:13n,  minted:0n, price:BigInt("15000000000000000"),  vaultLocked:false, active:true },
        { id:7n,  name:"Fleet Sigil",         season:1, power:75, tier:1, category:"relic",    maxSupply:21n,  minted:0n, price:BigInt("12000000000000000"),  vaultLocked:false, active:true },
        { id:8n,  name:"Zone Key: Void Core", season:1, power:72, tier:1, category:"key",      maxSupply:30n,  minted:0n, price:BigInt("10000000000000000"),  vaultLocked:false, active:true },
        { id:9n,  name:"Cyber Steed",         season:1, power:70, tier:1, category:"vehicle",  maxSupply:33n,  minted:0n, price:BigInt("9000000000000000"),   vaultLocked:false, active:true },
        { id:10n, name:"Signal Cloak",        season:1, power:68, tier:1, category:"skin",     maxSupply:36n,  minted:0n, price:BigInt("8000000000000000"),   vaultLocked:false, active:true },
        { id:11n, name:"Oracle Lens",         season:1, power:65, tier:1, category:"relic",    maxSupply:42n,  minted:0n, price:BigInt("7000000000000000"),   vaultLocked:false, active:true },
        { id:12n, name:"Swarm Drone",         season:1, power:60, tier:1, category:"companion",maxSupply:69n,  minted:0n, price:BigInt("5000000000000000"),   vaultLocked:false, active:true },
        // Alpha
        { id:13n, name:"Void Katana α",       season:1, power:57, tier:2, category:"weapon",   maxSupply:9n,   minted:0n, price:BigInt("12000000000000000"),  vaultLocked:true,  active:true },
        { id:14n, name:"Ghost Armor α",       season:1, power:55, tier:2, category:"armor",    maxSupply:18n,  minted:0n, price:BigInt("10000000000000000"),  vaultLocked:true,  active:true },
        { id:15n, name:"Neural Crown α",      season:1, power:53, tier:2, category:"relic",    maxSupply:27n,  minted:0n, price:BigInt("9000000000000000"),   vaultLocked:true,  active:true },
        { id:16n, name:"Samaur-AI Scroll α",  season:1, power:51, tier:2, category:"relic",    maxSupply:33n,  minted:0n, price:BigInt("8000000000000000"),   vaultLocked:true,  active:true },
        { id:17n, name:"Phantom Blade α",     season:1, power:49, tier:2, category:"weapon",   maxSupply:36n,  minted:0n, price:BigInt("7000000000000000"),   vaultLocked:true,  active:true },
        { id:18n, name:"Hex Shield α",        season:1, power:48, tier:2, category:"armor",    maxSupply:39n,  minted:0n, price:BigInt("6000000000000000"),   vaultLocked:true,  active:true },
        { id:19n, name:"Fleet Sigil α",       season:1, power:45, tier:2, category:"relic",    maxSupply:63n,  minted:0n, price:BigInt("5000000000000000"),   vaultLocked:true,  active:true },
        { id:20n, name:"Zone Key α",          season:1, power:43, tier:2, category:"key",      maxSupply:90n,  minted:0n, price:BigInt("4000000000000000"),   vaultLocked:true,  active:true },
        { id:21n, name:"Cyber Steed α",       season:1, power:42, tier:2, category:"vehicle",  maxSupply:99n,  minted:0n, price:BigInt("4000000000000000"),   vaultLocked:true,  active:true },
        { id:22n, name:"Signal Cloak α",      season:1, power:41, tier:2, category:"skin",     maxSupply:108n, minted:0n, price:BigInt("3000000000000000"),   vaultLocked:true,  active:true },
        { id:23n, name:"Oracle Lens α",       season:1, power:39, tier:2, category:"relic",    maxSupply:126n, minted:0n, price:BigInt("3000000000000000"),   vaultLocked:true,  active:true },
        { id:24n, name:"Swarm Drone α",       season:1, power:36, tier:2, category:"companion",maxSupply:207n, minted:0n, price:BigInt("2000000000000000"),   vaultLocked:true,  active:true },
      ];
      setItems(mock);
    } catch {
